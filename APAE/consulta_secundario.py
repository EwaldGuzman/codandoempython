...
class Pesquisar_Consulta:
    ...
    def contains(self):
        ...
        self.campo_fr = CTkFrame(self.Yscroll, width=size.container_w(100), height=size.container_h(20), fg_color='transparent')
        self.pesquisa_fr = CTkFrame(self.campo_fr, width=size.container_w(100), height=size.container_h(20), fg_color='transparent')
        self.tabela_fr = CTkFrame(self.Yscroll, width=size.container_w(100), height=size.container_h(20), fg_color='transparent')
    ...
    def lista(self):
        ...
        self.lista_treeview = ttk.Treeview(self.tabela_fr, columns=('', '', '', '', '', '', '', '', '', '', '', ''), show='headings', height=15, yscrollcommand=self.scroll_y.set)

        self.lista_treeview.column('#1', width=int(size.container_w(6)))
        self.lista_treeview.column('#2', width=int(size.container_w(6)))
        ...
        self.lista_treeview.column('#6', width=int(size.container_w(6)))
        ...
        self.lista_treeview.column('#11', width=int(size.container_w(5)))
        self.lista_treeview.column('#12', width=int(size.container_w(10)))


        self.lista_treeview.heading('#1', text='DATA')
        ...
        self.lista_treeview.heading('#12', text='DESCRIÇÃO')
    ...
    def editar_cadastro(self, a):
        ...
        self.ver_btn = CTkButton(self.option_cad, text='Visualizar ficha', width=size.container_w(5), height=size.container_h(30), command=self.visualizar_ficha)
        self.excluir_btn = CTkButton(self.option_cad, text='Excluir ficha', width=size.container_w(5), height=size.container_h(30), command=self.excluir_ficha)
        ...
        self.sus_entry.insert(0, infor[2])
        self.paciente_entry.insert(0, infor[3])
        self.data_entry.insert(0, infor[4])
    ...
    def visualizar_ficha(self):

        i = self.lista_treeview.selection()[0]
        infor = self.lista_treeview.item(i, 'values')

        import consulta_terciario
        consulta_terciario.Visualiza_Consulta(self.windows, infor, self.user)
    ...
    def excluir_ficha(self):

        dados = pd.read_excel(self.cadastro)

        i = self.lista_treeview.selection()[0]
        value = self.lista_treeview.item(i, 'values')

        dados = self.filtro3x(dados)

        messagebox.showinfo('', f'{dados}')
